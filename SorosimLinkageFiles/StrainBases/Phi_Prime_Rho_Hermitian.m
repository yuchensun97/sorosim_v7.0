function Phi_Prime_Rho = Phi_Prime_Rho_Hermitian(X, Bdof, Bodr)
    %Phi_Prime_Rho_Hermitian generate the basis function of mixed boundary condition
...
%   eg. Bodr = 1 implies linear inflation ratio.
    ...
    Phi_Prime_Rho = Phi_Prime_Rho(2:end-1);
end
