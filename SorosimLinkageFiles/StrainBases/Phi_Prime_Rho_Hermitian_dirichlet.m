function Phi_Prime_Rho = Phi_Prime_Rho_Hermitian_dirichlet(X, Bdof, Bodr)
    %Phi_Prime_Rho_Hermitian generate the basis function of dirichlet boundary condition
