...
results = Phi_Prime_Rho_Hermitian(X(1), Bdof, Bodr);
for i = 2:length(X)
    result = Phi_Prime_Rho_Hermitian(X(i), Bdof, Bodr);
...
exportgraphics(gcf, './figures/Phi_Prime_Rho_Hermitian.pdf','ContentType','vector');
