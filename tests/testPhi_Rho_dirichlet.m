...
results = Phi_Rho_Hermitian_dirichlet(X(1), Bdof, Bodr);
for i = 2:length(X)
    result = Phi_Rho_Hermitian_dirichlet(X(i), Bdof, Bodr);
...
exportgraphics(gcf, './figures/Phi_Rho_dirichlet.pdf','ContentType','vector');
