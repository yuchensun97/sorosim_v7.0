...
results = Phi_Rho_Hermitian_neumann(X(1), Bdof, Bodr);
for i = 2:length(X)
    result = Phi_Rho_Hermitian_neumann(X(i), Bdof, Bodr);
...
exportgraphics(gcf, './figures/Phi_Rho_neumann.pdf','ContentType','vector');
